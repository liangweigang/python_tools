    ...
    for list in find_list1:
        ...
        for i in range(len(sublist)):
            ...
            if i == 0:
                ...
                a = li.find('orange">')+8
                b = li.find('</span')
                it = li[a:b].replace('Ԫ/��','').replace('Ԫ/ͨ��','')
...
def getContentOfSingleDay(startDayStr,endDayStr):
    ...
    for list in find_list1:
        ...
        game_server = game_server.replace('</li>','')
        game_server = game_server.replace('��Ϸ/��/��/��Ӫ��������Ե��/','')
        a = game_server.find('��/') + 2
        ...
        price = price.replace('Ԫ','')
        price = price.replace(',','')
        
        
        unit_price = sublist[4]
        unit_price = unit_price.replace('Ԫ/ͨ��','').replace('Ԫ/��','')
